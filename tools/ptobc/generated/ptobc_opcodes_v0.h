...
// Generated base table plus audited 0.58.1 schema transformation; see
// tools/ptobc/update_v0581_schema.py and tools/ptobc/MAINTENANCE.md.
#pragma once
...
inline constexpr OpInfo kOpTable[] = {
  ...
  {0x102A, "pto.tgemv", 1, 0x00, 0x02, 0, 0, 0, 0x00},
  {0x102B, "pto.tgetval", 0, 0x01, 0x00, 2, 1, 0, 0x00},
  {0x102C, "pto.timg2col", 0, 0x00, 0x00, 4, 0, 0, 0x00},
  ...
  {0x1033, "pto.tmatmul.mx", 1, 0x00, 0x02, 0, 0, 0, 0x00},
  ...
  {0x1045, "pto.tprefetch", 0, 0x00, 0x00, 5, 0, 0, 0x00},
  ...
  {0x10A1, "pto.gmov", 0, 0x00, 0x00, 3, 0, 0, 0x00},
  {0x10A2, "pto.tfma", 0, 0x00, 0x00, 4, 0, 0, 0x00},
  ...
  {0x4000, "scf.for", 0, 0x02, 0x02, 0, 0, 1, 0x00},
  {0x4001, "scf.if", 0, 0x02, 0x00, 1, 0, 2, 0x00},
...
inline std::optional<uint16_t> lookupOpcodeByName(llvm::StringRef name) {
  uint16_t v = llvm::StringSwitch<uint16_t>(name)
    ...
    .Case("pto.gmov", 0x10A1)
    .Case("pto.tfma", 0x10A2)
    .Case("scf.for", 0x4000)
    .Case("scf.if", 0x4001)
...
inline std::optional<OpcodeAndVariant> lookupOpcodeAndVariantByFullName(llvm::StringRef fullName) {
  ...
  return llvm::StringSwitch<std::optional<OpcodeAndVariant>>(fullName)
    ...
    .Case("pto.gmov", OpcodeAndVariant{0x10A1, 0, 0})
    .Case("pto.tfma", OpcodeAndVariant{0x10A2, 0, 0})
